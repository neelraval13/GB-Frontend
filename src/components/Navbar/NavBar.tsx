...
import { handleDrawerOpen } from '../../appRedux/actions/Settings';
...
const NavBar : React.FC<Props> = (props) => {
  ...
  const renderMenu = (
    ...
    >
      ...
      <MenuItem onClick={handleMenuClose}><ToggleSwitch /></MenuItem>
    </Menu>
  );
  ...
  const renderMobileMenu = (
    ...
    return (
      ...
      <AppBar position="fixed" style={{backgroundColor:props.navColor,color:props.textColor}} >
        <Toolbar>
          <IconButton
            edge="start"
          ...
          <img src={props.navLogo} className='nav-logo' />
          <div className={props.theme === 'dark' ? classes.search : classes.lightSearch}>
